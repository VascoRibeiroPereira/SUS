...
## Extracção dos dados
dataFiles <- list.files("./2019/extratos", pattern = "csv$", full.names = TRUE)

contasDF <- read_delim("./2019/extratos/complete2019.csv", sep = ";")
...
if (dir.exists("./2019/tabelas_por_mes") == FALSE) dir.create("./2019/tabelas_por_mes")

library(openxlsx)
write.xlsx(listaMes, file = "./2019/tabelas_por_mes/tabelas.xlsx")
