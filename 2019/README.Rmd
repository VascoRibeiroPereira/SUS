...
A soma de todos os valores, por Centro de Custo é de `r sum(balancoAnualCC$Valores)`€, sendo este valor negativo devido à perda da principal fonte de rendimento da Sociedade União Sontrense: o aluguer do andar inferior.   
